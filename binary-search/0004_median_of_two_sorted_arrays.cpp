...
int main() {
  ...
  vector<int> nums2 = {2};
  cout << "Test 1: " << solution.findMedianSortedArrays(nums1, nums2)
       << endl; // Expected: 2.0

  // Test Case 2
  vector<int> nums3 = {1, 2};
  vector<int> nums4 = {3, 4};
  cout << "Test 2: " << solution.findMedianSortedArrays(nums3, nums4)
       << endl; // Expected: 2.5

  // Test Case 3: One empty array
  vector<int> nums5 = {};
  vector<int> nums6 = {1};
  cout << "Test 3: " << solution.findMedianSortedArrays(nums5, nums6)
       << endl; // Expected: 1.0

  // Test Case 4
  vector<int> nums7 = {1, 2, 3, 4, 5};
  vector<int> nums8 = {6, 7, 8, 9, 10};
  cout << "Test 4: " << solution.findMedianSortedArrays(nums7, nums8)
       << endl; // Expected: 5.5
