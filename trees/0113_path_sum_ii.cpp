 ...
 * should be returned as a list of the node values, not node references. A root-to-leaf
 * path is a path starting from the root and ending at any leaf node. A leaf is a
