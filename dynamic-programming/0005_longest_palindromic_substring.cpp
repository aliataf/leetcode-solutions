...
public:
   ...
   * Transition: s[j..i] is palindrome if s[j]==s[i] and (length<=3 or
   * s[j+1..i-1] is palindrome).
   *
...
int main() {
  ...
  // Test Case 1
  string s1 = "babad";
  cout << "Test 1: " << solution.longestPalindrome(s1)
       << endl; // Expected: "bab" or "aba"

  // Test Case 2
  string s2 = "cbbd";
  cout << "Test 2: " << solution.longestPalindrome(s2)
       << endl; // Expected: "bb"
  ...
  string s4 = "aaaa";
  cout << "Test 4: " << solution.longestPalindrome(s4)
       << endl; // Expected: "aaaa"

  // Test Case 5: No palindrome longer than 1
  string s5 = "abcd";
  cout << "Test 5: " << solution.longestPalindrome(s5)
       << endl; // Expected: "a" (or any single char)
