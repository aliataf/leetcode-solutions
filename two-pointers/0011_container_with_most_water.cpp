 ...
 * Output: 49
 * Explanation: The vertical lines are [1,8,6,2,5,4,8,3,7]. The max area is
 * between index 1 and 8, which is min(8,7) * (8-1) = 49.
 *
 * Example 2:
 * Input: height = [1,1]
 * Output: 1
...
public:
   ...
   * Move the pointer with smaller height inward to potentially find a taller
   * line.
   *
